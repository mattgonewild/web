...
/// tests for OAuth2Api
void main() {
  // final instance = OAuth2Api();

  group('tests for OAuth2Api', () {
    ...
    //
    //Future<List<OAuth2Client>> listOAuth2Clients({ int pageSize, String pageToken, String clientName, String owner }) async
    ...
    //
    //Future<List<OAuth2ConsentSession>> listOAuth2ConsentSessions(String subject, { int pageSize, String pageToken, String loginSessionId }) async
    ...
    //
    //Future<List<TrustedOAuth2JwtGrantIssuer>> listTrustedOAuth2JwtGrantIssuers({ int maxItems, int defaultItems, String issuer }) async
    ...
    //
    //Future<OAuth2Client> patchOAuth2Client(String id, List<JsonPatch> jsonPatch) async
