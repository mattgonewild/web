...
void main() {
  // final instance = OAuth2ConsentRequestOpenIDConnectContext();

  group('test OAuth2ConsentRequestOpenIDConnectContext', () {
    ...
    // Map<String, Object> idTokenHintClaims (default value: const {})
