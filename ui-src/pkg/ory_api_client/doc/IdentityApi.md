# ory_api_client.api.IdentityApi
...
try {
    final result = api_instance.createIdentity(createIdentityBody);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.createRecoveryCodeForIdentity(createRecoveryCodeForIdentityBody);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.createRecoveryLinkForIdentity(createRecoveryLinkForIdentityBody);
    print(result);
} catch (e) {
...
try {
    api_instance.deleteIdentitySessions(id);
} catch (e) {
...
try {
    api_instance.disableSession(id);
} catch (e) {
...
try {
    final result = api_instance.extendSession(id);
    print(result);
} catch (e) {
...
final includeCredential = []; // List<String> | Include Credentials in Response  Currently, only `oidc` is supported. This will return the initial OAuth 2.0 Access, Refresh and (optionally) OpenID Connect ID Token.

try {
    final result = api_instance.getIdentity(id, includeCredential);
    print(result);
} catch (e) {
 ...
 **includeCredential** | [**List<String>**](String.md)| Include Credentials in Response  Currently, only `oidc` is supported. This will return the initial OAuth 2.0 Access, Refresh and (optionally) OpenID Connect ID Token. | [optional] [default to const []]
...
final api_instance = IdentityApi();
final id = id_example; // String | ID is the session's ID.
final expand = []; // List<String> | ExpandOptions is a query parameter encoded list of all properties that must be expanded in the Session. Example - ?expand=Identity&expand=Devices If no value is provided, the expandable properties are skipped.

try {
    final result = api_instance.getSession(id, expand);
    print(result);
} catch (e) {
...
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID is the session's ID. | 
 **expand** | [**List<String>**](String.md)| ExpandOptions is a query parameter encoded list of all properties that must be expanded in the Session. Example - ?expand=Identity&expand=Devices If no value is provided, the expandable properties are skipped. | [optional] [default to const []]
...
try {
    final result = api_instance.listIdentitySessions(id, perPage, page, active);
    print(result);
} catch (e) {
...
final active = true; // bool | Active is a boolean flag that filters out sessions based on the state. If no value is provided, all sessions are returned.
final expand = []; // List<String> | ExpandOptions is a query parameter encoded list of all properties that must be expanded in the Session. If no value is provided, the expandable properties are skipped.

try {
    final result = api_instance.listSessions(pageSize, pageToken, active, expand);
    print(result);
} catch (e) {
 ...
 **active** | **bool**| Active is a boolean flag that filters out sessions based on the state. If no value is provided, all sessions are returned. | [optional] 
 **expand** | [**List<String>**](String.md)| ExpandOptions is a query parameter encoded list of all properties that must be expanded in the Session. If no value is provided, the expandable properties are skipped. | [optional] [default to const []]
...
try {
    final result = api_instance.patchIdentity(id, jsonPatch);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.updateIdentity(id, updateIdentityBody);
    print(result);
} catch (e) {
