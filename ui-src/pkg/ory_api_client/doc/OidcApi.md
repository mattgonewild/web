...
final api_instance = OidcApi();
final oAuth2Client = OAuth2Client(); // OAuth2Client | Dynamic Client Registration Request Body

try {
    final result = api_instance.createOidcDynamicClient(oAuth2Client);
    print(result);
} catch (e) {
...
try {
    api_instance.deleteOidcDynamicClient(id);
} catch (e) {
...
try {
    final result = api_instance.getOidcDynamicClient(id);
    print(result);
} catch (e) {
...
try {
    api_instance.revokeOidcSession();
} catch (e) {
...
try {
    final result = api_instance.setOidcDynamicClient(id, oAuth2Client);
    print(result);
} catch (e) {
