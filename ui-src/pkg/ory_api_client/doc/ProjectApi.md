...
final api_instance = ProjectApi();
final project = project_example; // String | The Project ID or Project slug
final createProjectApiKeyRequest = CreateProjectApiKeyRequest(); // CreateProjectApiKeyRequest | 

try {
    final result = api_instance.createProjectApiKey(project, createProjectApiKeyRequest);
    print(result);
} catch (e) {
...
final api_instance = ProjectApi();
final project = project_example; // String | The Project ID or Project slug
final tokenId = tokenId_example; // String | The Token ID

try {
    api_instance.deleteProjectApiKey(project, tokenId);
} catch (e) {
...
try {
    final result = api_instance.getActiveProjectInConsole();
    print(result);
} catch (e) {
...
try {
    final result = api_instance.listProjectApiKeys(project);
    print(result);
} catch (e) {
...
try {
    api_instance.setActiveProjectInConsole(setActiveProjectInConsoleBody);
} catch (e) {
...
try {
    final result = api_instance.setProject(projectId, setProject);
    print(result);
} catch (e) {
