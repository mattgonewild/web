# ory_api_client.api.FrontendApi
...
final api_instance = FrontendApi();
...
final loginChallenge = loginChallenge_example; // String | An optional Hydra login challenge. If present, Kratos will cooperate with Ory Hydra to act as an OAuth2 identity provider.  The value for this parameter comes from `login_challenge` URL Query parameter sent to your application (e.g. `/login?login_challenge=abcde`).

try {
    final result = api_instance.createBrowserLoginFlow(refresh, aal, returnTo, cookie, loginChallenge);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.createBrowserLogoutFlow(cookie);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.createBrowserRecoveryFlow(returnTo);
    print(result);
} catch (e) {
...
final api_instance = FrontendApi();
final returnTo = returnTo_example; // String | The URL to return the browser to after the flow was completed.
final loginChallenge = loginChallenge_example; // String | Ory OAuth 2.0 Login Challenge.  If set will cooperate with Ory OAuth2 and OpenID to act as an OAuth2 server / OpenID Provider.  The value for this parameter comes from `login_challenge` URL Query parameter sent to your application (e.g. `/registration?login_challenge=abcde`).  This feature is compatible with Ory Hydra when not running on the Ory Network.

try {
    final result = api_instance.createBrowserRegistrationFlow(returnTo, loginChallenge);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.createBrowserSettingsFlow(returnTo, cookie);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.createBrowserVerificationFlow(returnTo);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.createNativeLoginFlow(refresh, aal, xSessionToken);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.createNativeRecoveryFlow();
    print(result);
} catch (e) {
...
try {
    final result = api_instance.createNativeRegistrationFlow();
    print(result);
} catch (e) {
...
try {
    final result = api_instance.createNativeSettingsFlow(xSessionToken);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.createNativeVerificationFlow();
    print(result);
} catch (e) {
...
try {
    final result = api_instance.disableMyOtherSessions(xSessionToken, cookie);
    print(result);
} catch (e) {
...
try {
    api_instance.disableMySession(id, xSessionToken, cookie);
} catch (e) {
...
try {
    final result = api_instance.getFlowError(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getLoginFlow(id, cookie);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getRecoveryFlow(id, cookie);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getRegistrationFlow(id, cookie);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getSettingsFlow(id, xSessionToken, cookie);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getVerificationFlow(id, cookie);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.listMySessions(perPage, page, xSessionToken, cookie);
    print(result);
} catch (e) {
...
try {
    api_instance.performNativeLogout(performNativeLogoutBody);
} catch (e) {
...
final cookie = ory_session=a19iOVAbdzdgl70Rq1QZmrKmcjDtdsviCTZx7m9a9yHIUS8Wa9T7hvqyGTsLHi6Qifn2WUfpAKx9DWp0SJGleIn9vh2YF4A16id93kXFTgIgmwIOvbVAScyrx7yVl6bPZnCx27ec4WQDtaTewC1CpgudeDV2jQQnSaCP6ny3xa8qLH-QUgYqdQuoA_LF1phxgRCUfIrCLQOkolX5nv3ze_f==; // String | Set the Cookie Header. This is especially useful when calling this endpoint from a server-side application. In that scenario you must include the HTTP Cookie Header which originally was included in the request to your server. An example of a session in the HTTP Cookie Header is: `ory_kratos_session=a19iOVAbdzdgl70Rq1QZmrKmcjDtdsviCTZx7m9a9yHIUS8Wa9T7hvqyGTsLHi6Qifn2WUfpAKx9DWp0SJGleIn9vh2YF4A16id93kXFTgIgmwIOvbVAScyrx7yVl6bPZnCx27ec4WQDtaTewC1CpgudeDV2jQQnSaCP6ny3xa8qLH-QUgYqdQuoA_LF1phxgRCUfIrCLQOkolX5nv3ze_f==`.  It is ok if more than one cookie are included here as all other cookies will be ignored.
...
try {
    final result = api_instance.updateLoginFlow(flow, updateLoginFlowBody, xSessionToken, cookie);
    print(result);
} catch (e) {
...
try {
    api_instance.updateLogoutFlow(token, returnTo);
} catch (e) {
...
try {
    final result = api_instance.updateRecoveryFlow(flow, updateRecoveryFlowBody, token, cookie);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.updateRegistrationFlow(flow, updateRegistrationFlowBody, cookie);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.updateSettingsFlow(flow, updateSettingsFlowBody, xSessionToken, cookie);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.updateVerificationFlow(flow, updateVerificationFlowBody, token, cookie);
    print(result);
} catch (e) {
