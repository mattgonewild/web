...
final consentChallenge = consentChallenge_example; // String | OAuth 2.0 Consent Request Challenge
final acceptOAuth2ConsentRequest = AcceptOAuth2ConsentRequest(); // AcceptOAuth2ConsentRequest | 

try {
    final result = api_instance.acceptOAuth2ConsentRequest(consentChallenge, acceptOAuth2ConsentRequest);
    print(result);
} catch (e) {
...
final api_instance = OAuth2Api();
final loginChallenge = loginChallenge_example; // String | OAuth 2.0 Login Request Challenge
final acceptOAuth2LoginRequest = AcceptOAuth2LoginRequest(); // AcceptOAuth2LoginRequest | 

try {
    final result = api_instance.acceptOAuth2LoginRequest(loginChallenge, acceptOAuth2LoginRequest);
    print(result);
} catch (e) {
...
final api_instance = OAuth2Api();
final logoutChallenge = logoutChallenge_example; // String | OAuth 2.0 Logout Request Challenge

try {
    final result = api_instance.acceptOAuth2LogoutRequest(logoutChallenge);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.createOAuth2Client(oAuth2Client);
    print(result);
} catch (e) {
...
try {
    api_instance.deleteTrustedOAuth2JwtGrantIssuer(id);
} catch (e) {
...
try {
    final result = api_instance.getOAuth2ConsentRequest(consentChallenge);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getOAuth2LoginRequest(loginChallenge);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getOAuth2LogoutRequest(logoutChallenge);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getTrustedOAuth2JwtGrantIssuer(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.listOAuth2Clients(pageSize, pageToken, clientName, owner);
    print(result);
} catch (e) {
...
final pageSize = 789; // int | Items per Page  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.sh/docs/ecosystem/api-design#pagination).
final pageToken = pageToken_example; // String | Next Page Token  The next page token. For details on pagination please head over to the [pagination documentation](https://www.ory.sh/docs/ecosystem/api-design#pagination).
final loginSessionId = loginSessionId_example; // String | The login session id to list the consent sessions for.

try {
    final result = api_instance.listOAuth2ConsentSessions(subject, pageSize, pageToken, loginSessionId);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.listTrustedOAuth2JwtGrantIssuers(maxItems, defaultItems, issuer);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.oAuth2Authorize();
    print(result);
} catch (e) {
...
try {
    final result = api_instance.oauth2TokenExchange(grantType, clientId, code, redirectUri, refreshToken);
    print(result);
} catch (e) {
...
final api_instance = OAuth2Api();
final id = id_example; // String | The id of the OAuth 2.0 Client.
final jsonPatch = [List<JsonPatch>()]; // List<JsonPatch> | OAuth 2.0 Client JSON Patch Body

try {
    final result = api_instance.patchOAuth2Client(id, jsonPatch);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.rejectOAuth2ConsentRequest(consentChallenge, rejectOAuth2Request);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.rejectOAuth2LoginRequest(loginChallenge, rejectOAuth2Request);
    print(result);
} catch (e) {
...
try {
    api_instance.rejectOAuth2LogoutRequest(logoutChallenge);
} catch (e) {
...
final api_instance = OAuth2Api();
final subject = subject_example; // String | OAuth 2.0 Consent Subject  The subject whose consent sessions should be deleted.
final client = client_example; // String | OAuth 2.0 Client ID  If set, deletes only those consent sessions that have been granted to the specified OAuth 2.0 Client ID.
final all = true; // bool | Revoke All Consent Sessions  If set to `true` deletes all consent sessions by the Subject that have been granted.

try {
    api_instance.revokeOAuth2ConsentSessions(subject, client, all);
} catch (e) {
...
final api_instance = OAuth2Api();
final subject = subject_example; // String | OAuth 2.0 Subject  The subject to revoke authentication sessions for.

try {
    api_instance.revokeOAuth2LoginSessions(subject);
} catch (e) {
...
try {
    api_instance.revokeOAuth2Token(token, clientId, clientSecret);
} catch (e) {
...
final api_instance = OAuth2Api();
final id = id_example; // String | OAuth 2.0 Client ID
final oAuth2Client = OAuth2Client(); // OAuth2Client | OAuth 2.0 Client Request Body

try {
    final result = api_instance.setOAuth2Client(id, oAuth2Client);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.setOAuth2ClientLifespans(id, oAuth2ClientTokenLifespans);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.trustOAuth2JwtGrantIssuer(trustOAuth2JwtGrantIssuer);
    print(result);
} catch (e) {
