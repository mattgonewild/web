...
String parameterToString(dynamic value) {
  ...
  if (value is CourierMessageStatus) {
    return CourierMessageStatusTypeTransformer().encode(value).toString();
  }
  if (value is CourierMessageType) {
    return CourierMessageTypeTypeTransformer().encode(value).toString();
  }
  ...
  if (value is NullPlan) {
    return NullPlanTypeTransformer().encode(value).toString();
  }
  if (value is RecoveryFlowState) {
    return RecoveryFlowStateTypeTransformer().encode(value).toString();
  }
  if (value is SettingsFlowState) {
    return SettingsFlowStateTypeTransformer().encode(value).toString();
  }
  if (value is VerificationFlowState) {
    return VerificationFlowStateTypeTransformer().encode(value).toString();
  }
