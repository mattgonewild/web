...
class SelfServiceFlowExpiredError {
  ...
  @override
  String toString() => 'SelfServiceFlowExpiredError[code=$code, debug=$debug, details=$details, expiredAt=$expiredAt, id=$id, message=$message, reason=$reason, request=$request, since=$since, status=$status, useFlowId=$useFlowId]';
  ...
  static SelfServiceFlowExpiredError? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SelfServiceFlowExpiredError(
        ...
        expiredAt: mapDateTime(json, r'expired_at', ''),
