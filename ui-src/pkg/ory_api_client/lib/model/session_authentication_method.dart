...
class SessionAuthenticationMethodMethodEnum {
  ...
  static const codeRecovery = SessionAuthenticationMethodMethodEnum._(r'code_recovery');
  ...
  SessionAuthenticationMethodMethodEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'code_recovery': return SessionAuthenticationMethodMethodEnum.codeRecovery;
