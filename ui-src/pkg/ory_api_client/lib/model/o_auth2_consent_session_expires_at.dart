...
class OAuth2ConsentSessionExpiresAt {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.accessToken != null) {
      json[r'access_token'] = this.accessToken!.toUtc().toIso8601String();
    } else {
      json[r'access_token'] = null;
    }
    if (this.authorizeCode != null) {
      json[r'authorize_code'] = this.authorizeCode!.toUtc().toIso8601String();
    } else {
      json[r'authorize_code'] = null;
    }
    if (this.idToken != null) {
      json[r'id_token'] = this.idToken!.toUtc().toIso8601String();
    } else {
      json[r'id_token'] = null;
    }
    if (this.parContext != null) {
      json[r'par_context'] = this.parContext!.toUtc().toIso8601String();
    } else {
      json[r'par_context'] = null;
    }
    if (this.refreshToken != null) {
      json[r'refresh_token'] = this.refreshToken!.toUtc().toIso8601String();
    } else {
