...
class NormalizedProjectRevisionIdentitySchema {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.identitySchema != null) {
      json[r'identity_schema'] = this.identitySchema;
    } else {
      json[r'identity_schema'] = null;
    }
    if (this.identitySchemaId != null) {
      json[r'identity_schema_id'] = this.identitySchemaId;
    } else {
      json[r'identity_schema_id'] = null;
    }
    if (this.importId != null) {
      json[r'import_id'] = this.importId;
    } else {
      json[r'import_id'] = null;
    }
    if (this.importUrl != null) {
      json[r'import_url'] = this.importUrl;
    } else {
      json[r'import_url'] = null;
    }
