...
class Subscription {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.ongoingStripeCheckoutId != null) {
      json[r'ongoing_stripe_checkout_id'] = this.ongoingStripeCheckoutId;
    } else {
      json[r'ongoing_stripe_checkout_id'] = null;
    }
      json[r'payed_until'] = this.payedUntil.toUtc().toIso8601String();
    if (this.planChangesAt != null) {
      json[r'plan_changes_at'] = this.planChangesAt!.toUtc().toIso8601String();
    } else {
      json[r'plan_changes_at'] = null;
    }
      json[r'plan_changes_to'] = this.planChangesTo;
