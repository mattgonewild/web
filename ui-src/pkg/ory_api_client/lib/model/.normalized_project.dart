...
class NormalizedProject {
  ...
  @override
  String toString() => 'NormalizedProject[createdAt=$createdAt, currentRevision=$currentRevision, hosts=$hosts, id=$id, slug=$slug, state=$state, subscriptionId=$subscriptionId, updatedAt=$updatedAt]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'created_at'] = this.createdAt.toUtc().toIso8601String();
      json[r'current_revision'] = this.currentRevision;
